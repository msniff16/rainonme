...
class ForecastIO{
  ...
  /**
   * Will return conditions on minutely basis for today
   *
   * @param type $latitude
   * @param type $longitude
   * @return \ForecastIOConditions|boolean
   */
  function getForecastTodayMinute($latitude, $longitude) {
    ...
    if ($data !== false) {
      ...
      foreach ($data->minutely->data as $raw_data) {
   ...
   * @return \ForecastIOConditions|boolean
   */
  function getForecastTodayHourly($latitude, $longitude) {
  ...
  //Get summary of conditions for the hour
  function getForecastSummaryHourly($latitude, $longitude) {
  ...
  //Get summary of conditions for the day
  function getForecastSummaryToday($latitude, $longitude) {
  ...
  //Get summary of conditions for the day
  function getForecastSummaryWeekly($latitude, $longitude) {
...
class ForecastIOConditions{
 ...
 /**
   * Will return the precip intensity a value of 0 in./hr. corresponds to no precipitation,
...
/**
   * Will return the precip probability. Scale 0 to 1 inclusive.
   *
   * @return String
   */
